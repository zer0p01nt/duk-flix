  ...
  return (
    ...
    >
      ...
      <S.LinkBox $isWelcome={$isWelcome}>
        {$isMain ? (
          <li>
            <S.Link href='https://www.netflix.com/browse/audio-description'>
              화면 해설
            </S.Link>
          </li>
        ) : (
        ...
        {$isMain && (
          <li>
            <S.Link href='https://www.netflix.com/redeem'>기프트카드</S.Link>
          </li>
        )}
        {$isWelcome && (
          <li>
        ...
        {($isMain || $isWelcome) && (
          <li>
            <S.Link href='https://help.netflix.com/contactus'>문의하기</S.Link>
          </li>
        )}
        {$isWelcome && (
          <>
